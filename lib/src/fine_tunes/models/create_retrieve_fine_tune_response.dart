...
part 'create_retrieve_fine_tune_response.freezed.dart';
part 'create_retrieve_fine_tune_response.g.dart';

@freezed
class CreateRetrieveFineTuneResponse with _$CreateRetrieveFineTuneResponse {
  factory CreateRetrieveFineTuneResponse({
    required String id,
  ...
  }) = _CreateRetrieveFineTuneResponse;

  factory CreateRetrieveFineTuneResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateRetrieveFineTuneResponseFromJson(json);
}
