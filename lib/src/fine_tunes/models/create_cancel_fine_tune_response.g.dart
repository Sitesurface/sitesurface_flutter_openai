...
_$_CreateCancelFineTuneResponse _$$_CreateCancelFineTuneResponseFromJson(
...
Map<String, dynamic> _$$_CreateCancelFineTuneResponseToJson(
        _$_CreateCancelFineTuneResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
