...
part of 'create_cancel_fine_tune_response.dart';
...
CreateCancelFineTuneResponse _$CreateCancelFineTuneResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateCancelFineTuneResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCancelFineTuneResponse {
  ...
  @JsonKey(ignore: true)
  $CreateCancelFineTuneResponseCopyWith<CreateCancelFineTuneResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCancelFineTuneResponseCopyWith<$Res> {
  factory $CreateCancelFineTuneResponseCopyWith(
          CreateCancelFineTuneResponse value,
          $Res Function(CreateCancelFineTuneResponse) then) =
      _$CreateCancelFineTuneResponseCopyWithImpl<$Res,
          CreateCancelFineTuneResponse>;
  @useResult
  $Res call(
      {String id,
      String object,
...
/// @nodoc
class _$CreateCancelFineTuneResponseCopyWithImpl<$Res,
        $Val extends CreateCancelFineTuneResponse>
    implements $CreateCancelFineTuneResponseCopyWith<$Res> {
  _$CreateCancelFineTuneResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_CreateCancelFineTuneResponseCopyWith<$Res>
    implements $CreateCancelFineTuneResponseCopyWith<$Res> {
  factory _$$_CreateCancelFineTuneResponseCopyWith(
          _$_CreateCancelFineTuneResponse value,
          $Res Function(_$_CreateCancelFineTuneResponse) then) =
      __$$_CreateCancelFineTuneResponseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$_CreateCancelFineTuneResponseCopyWithImpl<$Res>
    extends _$CreateCancelFineTuneResponseCopyWithImpl<$Res,
        _$_CreateCancelFineTuneResponse>
    implements _$$_CreateCancelFineTuneResponseCopyWith<$Res> {
  __$$_CreateCancelFineTuneResponseCopyWithImpl(
      _$_CreateCancelFineTuneResponse _value,
      $Res Function(_$_CreateCancelFineTuneResponse) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_CreateCancelFineTuneResponse(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_CreateCancelFineTuneResponse implements _CreateCancelFineTuneResponse {
  _$_CreateCancelFineTuneResponse(
      {required this.id,
  ...
  factory _$_CreateCancelFineTuneResponse.fromJson(Map<String, dynamic> json) =>
      _$$_CreateCancelFineTuneResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCancelFineTuneResponse(id: $id, object: $object, model: $model, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, fineTunedModel: $fineTunedModel, organizationId: $organizationId, resultFiles: $resultFiles, validationFiles: $validationFiles, events: $events, hyperparams: $hyperparams, trainingFiles: $trainingFiles)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_CreateCancelFineTuneResponse &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_CreateCancelFineTuneResponseCopyWith<_$_CreateCancelFineTuneResponse>
      get copyWith => __$$_CreateCancelFineTuneResponseCopyWithImpl<
          _$_CreateCancelFineTuneResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CreateCancelFineTuneResponseToJson(
      this,
    );
  }
}

abstract class _CreateCancelFineTuneResponse
    implements CreateCancelFineTuneResponse {
  factory _CreateCancelFineTuneResponse(
  ...
  factory _CreateCancelFineTuneResponse.fromJson(Map<String, dynamic> json) =
      _$_CreateCancelFineTuneResponse.fromJson;
