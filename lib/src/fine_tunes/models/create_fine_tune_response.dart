...
part 'create_fine_tune_response.freezed.dart';
part 'create_fine_tune_response.g.dart';

@freezed
class CreateFineTuneResponse with _$CreateFineTuneResponse {
  factory CreateFineTuneResponse({
    required String id,
  ...
  }) = _CreateFineTuneResponse;

  factory CreateFineTuneResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateFineTuneResponseFromJson(json);
}
